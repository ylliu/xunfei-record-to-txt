...
class RequestApi(object):
    ...
    def gene_request(self, apiname, data, files=None, headers=None):
        ...
        if result["ok"] == 0:
            self.writeToFile(apiname, result)
            return result
        else:
    ...
    def writeToFile(self, apiname, result):
...
if __name__ == '__main__':
    api = RequestApi(appid="fb0d46b1", secret_key="28d4a3f53e3a0386ecb941522f1335c8",
                     upload_file_path=r"C:\\Users\\youlong\\Desktop\\3.m4a")
    api.all_api_request()
